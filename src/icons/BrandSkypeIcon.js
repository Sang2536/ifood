export default function BrandSkypeIcon ({ width = '1.5rem', height = '1.5rem', className = '' }) {
    return (
        <svg
            ...
            className={`${className} icon icon-tabler icons-tabler-outline icon-tabler-brand-skype`}
        >
