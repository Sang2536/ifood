export default function FilterFilledIcon({ width = '1.5rem', height = '1.5rem', className = '' }) {
    return (
        <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className={`${className} icon icon-tabler icons-tabler-filled icon-tabler-filter`}
        >
